...
function create_event($event) {
    ...
    $animal = $event["animal"];
    $query = "
        insert into dbAppointments (name, abbrevName, date, startTime, description, location, animal)
        values ('$name', '$abbrevName', '$date', '$startTime', '$description', '$location', '$animal')
    ";
    $result = mysqli_query($connection, $query);
    if (!$result) {
        return null;
...
function update_event($eventID, $eventDetails) {
    ...
    $animal = $eventDetails["animal"];
    $query = "
        update dbAppointments set name='$name', abbrevName='$abbrevName', date='$date', startTime='$startTime', description='$description', location='$location', animal='$animal'
        where id='$eventID'
    ";
    $result = mysqli_query($connection, $query);
    mysqli_commit($connection);
