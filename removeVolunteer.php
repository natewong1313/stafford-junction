<?php
session_start();
require_once('database/dbBusMonitorForm.php'); // Include the file with database functions
...
<script>
    ...
    document.querySelectorAll('[name="volunteers_to_remove[]"]').forEach((checkbox) => {
        checkbox.addEventListener('change', function () {
            const routeIdHidden = document.getElementById('route_id_hidden');
            const selectedRouteId = this.getAttribute('data-route-id'); // Get route ID from data attribute
